...
var botTexts = map[string]map[string]string{
	"en": {
		...
		"aggregator_min_price_created":      "🔍 The price you entered didn't match, but I found this page's lowest listed price: <b>%.2f %s</b> (you entered %.2f). I'm creating the tracker with the found price.",
	...
	"ru": {
		...
		"aggregator_min_price_created":      "🔍 Введённая цена не совпала, но я нашёл минимальную цену на этой странице: <b>%.2f %s</b> (вы вводили %.2f). Создаю трекер с найденной ценой.",
	...
	"pl": {
		...
		"aggregator_min_price_created":      "🔍 Podana cena się nie zgadzała, ale znalazłem najniższą cenę na tej stronie: <b>%.2f %s</b> (podano %.2f). Tworzę tracker ze znalezioną ceną.",
